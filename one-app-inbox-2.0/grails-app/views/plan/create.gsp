...
<html>
    <head>
        ...
        <title><g:message code="plan.create" default="Create Plan" /></title>
    </head>
    <body>
		        ...
		        <section class="container_6 clearfix">
					<div class="form grid_6">
			            <g:form action="save" method="post" >
			                 ...
			                 <div class="action">
			                    <g:submitButton name="create" class="button button-green" value="${message(code: 'create', 'default': 'Create')}" style="width: 120px"/>
			                </div>
			           </g:form>
		          </div>
		      </section>
