		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${billingHistoryInstanceList}" status="i" var="billingHistoryInstance">
					<li>
						<g:link action="show" id="${billingHistoryInstance.id}">${billingHistoryInstance}</g:link>
						<g:link action="edit" id="${billingHistoryInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
