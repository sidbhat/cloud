...
#field1405578341870ControlHolder ,#field1405419735946ControlHolder{
 ...
 function showTransfortdata(){
	 ...
	 $('#field1405419726005').keyup(function(){
			...
			$.ajax({
				type: 'GET',
				url: '/form-builder/PF/lookUp?field=20087&formId=1766&term='+$('#field1405419726005').val(),
				success: function (data, textStatus) {
					 var isHtml=""
					 for(var ix=0;ix<data.length;ix++){ 
						  isHtml=isHtml+"<tr class="+(ix%2==0?'even':'odd')+"><td><a href='https://app.oneappcloud.com/form-builder/PF/edit/"+data[ix].wholeObj.domid+"?formId=1767' target='_blank'> "+data[ix].wholeObj.field1405552812045+"</a></td><td>"+
								   data[ix].wholeObj.field1405552828520+"</td><td>"+
								   data[ix].wholeObj.field1405552838265+"</td></tr>"
						}
					if(data.length==0){
					   isHtml='<tr class="odd"><td valign="top" colspan="3" class="dataTables_empty" title="No data available in table">Not found <a href="https://app.oneappcloud.com/form-builder/PF/create?formId=1767" target="_blank"  >Click here to add new</a></td></tr>'
					}
