...
//					}
			...
			String key= uuid
            Client client_default = new Client(name: "Default Client", currency: 'USD',licenseCollaboration:true,licenseForms:true,consumerKey:key.replaceAll("-","")).save()
           ...
           // for ( int i=0; i < 4; i++){
			...
			// for ( int i=0; i < 4; i++){
				 publicUser = new User(
					 username: "publicuser@yourdomain.com",
