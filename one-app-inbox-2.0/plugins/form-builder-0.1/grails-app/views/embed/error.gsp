%{----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------}%
<html><head>
<meta name="layout" content="mainErrorEmbed"/>
...
<div id="sizedcontent" style="text-align:center;">
...
<div style="clear:both;font-size:0;min-height: 70px;"></div>
</div>
</div>
</div>
<%--</div>--%>
<div id="legal" style="text-align:center;margin:auto;"><div style="display:inline-block;padding:10px;border-radius:20px;font-size:14px;" class="buttons">Powered by <a href="http://sidbhat1976.blogspot.com/" target="_blank" style="text-decoration:underline !important;">Form Builder</a></div></div>
</form>
</body></html>