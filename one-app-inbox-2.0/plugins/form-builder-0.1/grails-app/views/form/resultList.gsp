							...
							<li ><a href="#" class="ShareMainBtn" style="font-weight: bold;">
						      <span class="exportIcon"></span><g:message code="export.label" default="Export"/><span class="arrow-down"></span></a>
									<ul style="width:110px;">
										<li>
											<g:link controller="home" action="exportToGoogleDocs" params="[formId:params.formId,format:'excel',extension:'xls',returnController:'formViewer']" onclick="loadScreenBlock();" style="width:105px;padding:6px 3px;"><g:message code="default.button.exportGoogleDocs.label" default="Google Docs" /><span class="googleDoc" style="float:left;margin-top:-2px;margin-left:5px;padding-left:5px;"></span></g:link>
										</li>
										<li>
											<g:link controller="formViewer" action="exportResponseList" params="[formId:params.formId,format:'pdf',extension:'pdf']" style="width:105px;padding:6px 3px;"><g:message code="default.button.exportGoogleDocs.label" default="Pdf" /><span class="pdf" style="float:left;margin-top:-2px;margin-left:5px;padding-left:5px;"></span></g:link>
										</li>
										<li class="Nobdr">
											<g:link controller="formViewer" action="exportResponseList" params="[formId:params.formId,format:'excel',extension:'xls']" style="width:105px;padding:6px 3px;"><g:message code="default.button.exportGoogleDocs.label" default="Excel" /><span class="excel" style="float:left;margin-top:-2px;margin-left:5px;padding-left:5px;"></span></g:link>
										</li>
									</ul>
								</li>
							</ul>
						...
						<div class="PostShare" style="width:120px;">
							...
							--%><ul style="width:120px;">
								<li ><a href="#" class="ShareMainBtn" style="font-weight: bold;">
									...
									<ul style="width:110px;">
										<li>
											<a href="/form-builder/formViewer/create?formId=${params.formId}" style="width:110px;padding:6px 3px;"><g:message code="default.button.create.label" default="Create"  /><span class="subForm" style="float:left;margin-top:-2px;margin-left:5px;padding-left:5px;"></span></a>
										</li>
										<li class="Nobdr">
