                ...
                if (key == 'editor') {
                    ...
                    switch (editorType.toLowerCase()) {
                        case 'text':
                            ...
                            break;
                        case 'number':
                            editorConstruction += "var ${editorName} = new YAHOO.widget.TextboxCellEditor({validator:YAHOO.widget.DataTable.validateNumber, ${grailsUITagLibService.mapToConfig(val.config)}});\n";
                            break;
                        case 'dropdown':
                    ...
                    def successCallback = val.onSuccess
                    def failureCallback = val.onFailure
                    editorConstruction += "registerEditorListener(${editorName}, '${configMap.key}', '${url}',${successCallback},${failureCallback});\n"
                }
            }
        }
        editorConstruction
