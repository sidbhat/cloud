...
class ResourcesTagLib implements ApplicationContextAware {
    ...
    def resources = {attrs ->
        ...
        if (!(mode in config.mode.keySet())) {
            throw new GrailsUIException("Resource mode must be within ${config.mode.keySet()}");
        }
        ...
        components.each {component ->
            ...
            if (!tagDefinition) {
                throw new GrailsUIException("[gui:resources] Invalid component: ${component}. Incorrect case or spelling?")
            }
