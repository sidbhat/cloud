...
var FormBuilder = {
  options: { // default options. values are stored in prototype
		fields: 'PlainText, SingleLineText, MultiLineText,dropdown,GroupButton,CheckBox,PlainTextHref',
		tabSelected: 0,
		readOnly: false,
		tabDisabled: [],
		formCounter: 1,
...
var FbSingleLineText = $.extend({}, $.fb.fbWidget.prototype, {
	options: { // default options. values are stored in widget's prototype
		/*name: '<span style="position:relative;z-index:1"><img src="../images/abc.bmp" style="position:absolute;left:-20px;z-index:2" >Single Line Text</span>',*/
        name: '<span style="position:relative;font-size:11px"><img src="../images/abc.bmp" style="position:absolute;left:-16px;z-index:2;width:20px" >&nbspSingle Line Text</span>',
...
var FbMultiLineText = $.extend({}, $.fb.fbWidget.prototype, {
	options: { // default options. values are stored in widget's prototype
		name: '<span style="position:relative;font-size:11px"><img src="../images/para.bmp" style="position:absolute;left:-16px;z-index:2;width:20px" >&nbspParagraph Text</span>',
		belongsTo: $.fb.formbuilder.prototype.options._standardFieldsPanel,
		_type: 'MultiLineText',
		_html : '<div><label><em></em><span></span></label> \
		      <textarea row="4" cols="20" class="textInput" /> \
	        <p class="formHint"></p></div>',
		_counterField: 'label',
		_languages: [ 'en', 'zh_CN' ],
		settings: {
		 ...
		 .keyup(function(event) {
           ...
           var length=value.length
            ...
            for(var i=0;i<substr.length-1;i++){
             option1+="<option>"+substr[i]+"</option>"
            }
            $('#'+ dropDown1).html(option1)
            $('#' + dropDown1).attr("id",length)
             dropDown1=length
...
var GroupButton = $.extend({}, $.fb.fbWidget.prototype, {
    options: { // default options. values are stored in widget's prototype
        name: '<span style="position:relative;font-size:11px"><img src="../images/radio.bmp" style="position:absolute;left:-16px;z-index:2;width:20px" >&nbspMultiple Choice</span>',
        belongsTo: $.fb.formbuilder.prototype.options._standardFieldsPanel,
        _type: 'GroupButton',
        _html : '<div>\
	        <input type="radio" id="checkbox"><label><span style="position:absolute;top:20px;left:50px"></span></label></div>',
        _counterField: 'label',
        _languages: [ 'en', 'zh_CN' ],
        settings: {
            en: {
    ...
    _getFieldSettingsLanguageSection : function(event, fb) {
        ...
        $('input', $value).val(fb.settings.value)
            ...
            $('#' + radioId).attr("name", value)
            $('#' + radioId).attr("id", "radio"+value)
             radioId="radio"+value
            //fb.item.find('.textInput').val(value);
            fb.settings.value = value;
            fb.target._updateSettings(fb.item);
...
$.widget('fb.fbGroupButton', GroupButton);
/*
 * JQuery Form Builder - Single Line Text plugin.
 *
 * Revision: ${svn.info.lastRev}
...
function setLabel(id) {
    $('#' + id + 's').text($('#' + id).val())
    $('#' + id + 't').prop('name', $('#' + id).val())
}


function addwidget(id) {
    var uniqid = new Date().getTime()
    $('#w' + id).after('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style="display:block" id="w' + uniqid + '"><input type="checkbox" id="' + uniqid + 't" style="width:10px;margin-right:10px;"><input type="Text" style="width:160px" value="Enter your Choice" id="' + uniqid + '"  onKeyUp=setLabel("' + uniqid + '")><a href="#" onclick=addwidget("' + uniqid + '")><img src="../images/add.png" style="width:20px;"></a><a href="#" onclick=removewidget("' + uniqid + '")><img src="../images/images.png" style="width:20px;"></a></div> ')
     $('#' + id + "d").after('<div id="' + uniqid + 'd"><input type="checkbox" value="" name="" id="' + uniqid + 't"><div id="' + uniqid + 'l" style="display:inline"><span id="' + uniqid + 's">Enter your Choice Choice</span></div><br/><br/></div> ')
...
var FbCheckBox = $.extend({}, $.fb.fbWidget.prototype, {
    options: { // default options. values are stored in widget's prototype
        name: '<span style="position:relative;font-size:11px"><img src="../images/check.bmp" style="position:absolute;left:-16px;z-index:2;width:15px" >&nbsp&nbsp&nbspCheckBoxes</span>',
        belongsTo: $.fb.formbuilder.prototype.options._standardFieldsPanel,
        _type: 'CheckBox',
        _html : '<div><label><span></span></label> \
		         <div id="FirstChoiced"><input type="checkbox" value="" name="FirstChoice" id="FirstChoicet"><div id="FirstChoicel" style="display:inline"><span id="FirstChoices">First Choice</span></div><br/><br/></div> \
				<div id="SecondChoiced"><input type="checkbox" value="" name="SecondChoice" id="SecondChoicet"><div id="SecondChoicel" style="display:inline"><span id="SecondChoices">Second Choice</span></div><br/><br/></div>\
				<div id="ThirdChoiced"><input type="checkbox" value="" name="ThirdChoice" id="ThirdChoicet"><div id="ThirdChoicel" style="display:inline"><span id="ThirdChoices">Third Choice</span></div><br/><br/></div>\
				</div>\
	       ',
        _counterField: 'label',
        _languages: [ 'en', 'zh_CN' ],
    ...
    _getFieldSettingsLanguageSection : function(event, fb) {
        var $label = fb.target._label({ label: 'Field Label (?)', name: 'field.label' })
                .append('<textarea rows="3" cols="20" id="field.label" />');
        ...
        /* var $value = fb.target._label({ label: 'Value', name: 'field.value' })
         ...
         .keyup(function(event) {
         var value = $(this).val();
         $('#' + checkBoxid).attr("name", value)
         $('#' + checkBoxid).attr("id", "check"+value)
         checkBoxid = "check"+value
         ...
         */
        var $choice = $('<div> \
				<div style="display:inline;" id="wFirstChoice"><input type="checkbox" id="FirstChoicet" style="width:10px;margin-right:10px;"><input type="Text" style="width:165px" value="First Choice" id="FirstChoice"   onKeyUp=setLabel("FirstChoice")><a href="#" onclick=addwidget("FirstChoice")><img src="../images/add.png" style="width:20px;"></a><a href="#" onclick=removewidget("FirstChoice")><img src="../images/images.png" style="width:20px;"></a></div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				<div style="display:inline;" id="wSecondChoice"><input type="checkbox" id="SecondChoicet" style="width:10px;margin-right:10px;"><input type="Text" style="width:160px" value="Second Choice" id="SecondChoice"   onKeyUp=setLabel("SecondChoice")><a href="#" onclick=addwidget("SecondChoice")><img src="../images/add.png" style="width:20px;"></a><a href="#" onclick=removewidget("SecondChoice")><img src="../images/images.png" style="width:20px;"></a></div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				<div style="display:block" id="wThirdChoice"><input type="checkbox" id="ThirdChoicet" style="width:10px;margin-right:10px;"><input type="Text" style="width:160px" value="Third Choice" id="ThirdChoice"   onKeyUp=setLabel("ThirdChoice")><a href="#" onclick=addwidget("ThirdChoice")><img src="../images/add.png" style="width:20px;"></a><a href="#" onclick=removewidget("ThirdChoice")><img src="../images/images.png" style="width:20px;"></a></div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				</div>');
...
var FbPlainTextHref = $.extend({}, $.fb.fbWidget.prototype, {
    options: { // default options. values are stored in widget's prototype
        ...
        belongsTo: $.fb.formbuilder.prototype.options._standardFieldsPanel,
        _type: 'PlainTextHref',
        _html : '<div><a href="#" id="link"> \
	      <label><span>Your HyperLink</span></label></a>  </div>',
        _counterField: 'label',
        _languages: [ 'en', 'zh_CN' ],
        settings: {
            en: {
