...
class AttachmentableGrailsPlugin {
    ...
    private void addControllerMethods(def config,
        ...
        mc.attachUploadedFilesTo = {reference, Long domainInstanceId = null, List inputNames = [] ->
            def controllerInstance = delegate
            def request = controllerInstance.request
            ...
            if (AttachmentableUtil.isAttachmentable(reference)) {
                ...
                if (request instanceof DefaultMultipartHttpServletRequest) {
                    ...
                    // upload
                    uploadedFiles = service.upload(user, reference, filesToUpload,domainInstanceId)
                }
    ...
    private void addDomainMethods(def config,
        ...
        mc.getDomainAttachments = {Long domainInstanceId, String inputName = null, params = [:] ->
            service.findAttachmentsByReference(delegate, inputName ? [inputName] : [], params, domainInstanceId)
        }
