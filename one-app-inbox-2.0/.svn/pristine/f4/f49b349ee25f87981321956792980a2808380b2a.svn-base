		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${accountInstanceList}" status="i" var="accountInstance">
					<li>
						<g:link action="edit" id="${accountInstance.id}">${accountInstance?.name}</g:link>
						<g:link action="edit" id="${accountInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
