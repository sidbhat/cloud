...
<div class='s2ui_center'>
    ...
    <div id="loginFormContainer" style='display:none' title="%{----------------------------------------------------------------------------
...
${message(code: 'spring.security.ui.login.signin')}">
        <g:form controller='j_spring_security_check' name="loginForm" autocomplete='off'>
            ...
            <input type="checkbox" class="checkbox" name="_spring_security_remember_me" id="remember_me"
                   checked="checked"/>
