...
public interface IMailChimpServices {
	 ...
	 */
	Object[] listMergeVars(String apiKey, String listId);
	
	/*
	 * Get the list of merge tags for a given list, including their name, tag, and required setting
	 * */
	Object[] listInterestGroupings(String apiKey, String listId);
	/*
	 * Get the list check boxes
	 * */
	...
	boolean listSubscribe(String apiKey, String listId, String email,
			Map<String, String> mergeVars, String emailType, boolean doubleOptin,boolean update,boolean replaceInterests,boolean welcomeEmail);
	...
	boolean listInterestGroupAdd(String apikey, String id, String name, Integer[] groups);
}
