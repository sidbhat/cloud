...
<head>
    ...
    <title><g:message code="account.edit" default="Edit Account"/></title>
</head>
...
<header>
    ...
    <h2>
        <g:message code="account.edit" default="Edit Account"/></h2>
        ...
        <div class="panes clearfix">
            ...
            <td valign="top" class="value ${hasErrors(bean: accountInstance, field: 'user', 'errors')}">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: accountInstance, field: 'contact', 'errors')}">
                        <g:select name="contact.id"
                                  from="${ContactDetails.list()}"
                                  optionKey="id" value="${accountInstance?.contact?.id}" noSelection="['null': '']"/>
            ...
            <section>
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: accountInstance, field: 'shipTo.city', 'errors')}">
            ...
            <section>
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: accountInstance, field: 'billTo.city', 'errors')}">
